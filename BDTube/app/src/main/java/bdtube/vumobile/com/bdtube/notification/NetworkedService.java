...
public class NetworkedService extends Service {
    ...
    private static String url2 = "http://wap.shabox.mobi/GCMPanel/bdtubepush.aspx?email=";
                ...
                try {
                    ...
                    for (int i = 0; i < contacts.length(); i++) {
                        ...
                        if (sample_url != null) {
                            ...
                            Utils.setCustomViewNotification(getApplicationContext(), sPhysicalFileName,StickerTitle, Push_Message, sample_url, i, contentCode, categoryCode, sContentType, sPhysicalFileName, ZedID, artist);
                            // SendLaunchPushRes();
